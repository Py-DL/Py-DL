...
*Py-DL* is a genuine, lightweight, dependency-free Python library (and command-line utility) for downloading YouTube videos.
...
*Py-DL* is a lightweight library written in Python. It has no third-party
dependencies and aims to be highly reliable.

*Py-DL* also makes pipelining easy, allowing you to specify callback functions for different download events, such as  ``on progress`` or ``on complete``.
...
```bash
$ python -m pip install git+https://github.com/Py-DL/Py-DL
```

### Using Py-DL in a Python script
...
```bash
$ Py-DL https://youtube.com/watch?v=2lAe1cqCOXo
```

You can also do the same for a playlist:
```bash
$ Py-DL https://www.youtube.com/playlist?list=PLS1QulWo1RIaJECMeUT4LFwJ-ghgoSH6n
```
