...
This guide will walk you through the basics of working with Py-DL Playlists.

Creating a Playlist
-------------------

Using Py-DL to interact with playlists is very simple. 
Begin by importing the Playlist class::

    >>> from Py-DL import Playlist
...
Now, we have a :class:`Playlist <Py-DL.Playlist>` object called ``p`` that we can do some work with.
