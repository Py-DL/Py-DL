...
API documentation here: :meth:`Py-DL.StreamQuery.filter`.
...
After you've selected the :class:`Stream <Py-DL.Stream>` you're interested,
...
documented in the API reference here: :meth:`Py-DL.Stream.download`.
