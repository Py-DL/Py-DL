...
from Py-DL import Caption, CaptionQuery, captions
...
@mock.patch("Py-DL.captions.Caption.generate_srt_captions")
...
@mock.patch("Py-DL.captions.Caption.xml_captions")
...
@mock.patch("Py-DL.captions.request")
