...
from Py-DL import Caption, CaptionQuery, cli, StreamQuery
from Py-DL.exceptions import PytubeError

parse_args = cli._parse_args


@mock.patch("Py-DL.cli._parse_args")
...
@mock.patch("Py-DL.cli.display_streams")
@mock.patch("Py-DL.cli.YouTube")
...
@mock.patch("Py-DL.cli._print_available_captions")
@mock.patch("Py-DL.cli.YouTube")
...
@mock.patch("Py-DL.cli.setup_logger", return_value=None)
...
@mock.patch("Py-DL.cli.YouTube", return_value=None)
...
@mock.patch("Py-DL.cli.YouTube", return_value=None)
@mock.patch("Py-DL.cli.download_by_resolution")
...
@mock.patch("Py-DL.cli.Playlist")
@mock.patch("Py-DL.cli._perform_args_on_youtube")
...
@mock.patch("Py-DL.cli.YouTube")
@mock.patch("Py-DL.StreamQuery")
@mock.patch("Py-DL.Stream")
@mock.patch("Py-DL.cli._download")
...
@mock.patch("Py-DL.cli.YouTube")
@mock.patch("Py-DL.cli.ffmpeg_process")
...
@mock.patch("Py-DL.cli.YouTube")
@mock.patch("Py-DL.cli._ffmpeg_downloader")
...
@mock.patch("Py-DL.cli.os.unlink", return_value=None)
@mock.patch("Py-DL.cli.subprocess.run", return_value=None)
@mock.patch("Py-DL.cli._download", return_value=None)
@mock.patch("Py-DL.cli._unique_name", return_value=None)
...
@mock.patch("Py-DL.cli.download_audio")
@mock.patch("Py-DL.cli.YouTube.__init__", return_value=None)
...
@mock.patch("Py-DL.cli.os.path.exists", return_value=False)
...
@mock.patch("c.cli.os.path.exists")
