...
from Py-DL import helpers
from Py-DL.exceptions import RegexMatchError
from Py-DL.helpers import cache, create_mock_html_json, deprecated, setup_logger
from Py-DL.helpers import target_directory, uniqueify
...
@mock.patch("Py-DL.helpers.logging")
...
@mock.patch('Py-DL.request.urlopen')
