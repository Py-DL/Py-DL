...
def test_js_caching(cipher_signature):
    assert Py-DL.__js__ is not None
    assert Py-DL.__js_url__ is not None
    assert Py-DL.__js__ == cipher_signature.js
    assert Py-DL.__js_url__ == cipher_signature.js_url
