...
def test_empty(test_input, cipher_signature):
    """Ensure :meth:`~Py-DL.StreamQuery.last` and
    :meth:`~Py-DL.StreamQuery.first` return None if the resultset is
    empty.
    """
...
def test_get_last(cipher_signature):
    """Ensure :meth:`~Py-DL.StreamQuery.last` returns the expected
    :class:`Stream <Stream>`.
    """
...
def test_get_first(cipher_signature):
    """Ensure :meth:`~Py-DL.StreamQuery.first` returns the expected
    :class:`Stream <Stream>`.
    """
...
def test_order_by(cipher_signature):
    """Ensure :meth:`~Py-DL.StreamQuery.order_by` sorts the list of
...
def test_order_by_descending(cipher_signature):
    """Ensure :meth:`~Py-DL.StreamQuery.desc` sorts the list of
...
def test_get_by_itag(cipher_signature):
    """Ensure :meth:`~Py-DL.StreamQuery.get_by_itag` returns the expected
    :class:`Stream <Stream>`.
    """
